...
x,y = create_data_stucture_neural_negetive(user_all_data, usernames, neg_class=20)
...
plt.ylabel("Accuracy")
plt.grid()
plt.savefig("./results/conv_1d_neg_acc.jpg", dpi=300, bbox_inches='tight')
plt.show()
...
plt.ylabel("Loss")
plt.grid()
plt.savefig("./results/conv_1d_neg_loss.jpg", dpi=300, bbox_inches='tight')
plt.show()
...
ax,cm = plot_confusion_matrix(total_targets, total_predicted, classes=class_names, normalize=False,
...
# Train accuracy: 1.0                                                                                                      │
# Test accuracy: 0.9505208333333334   